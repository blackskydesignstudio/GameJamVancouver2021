...
if(keyboard_check(ord("A"))) {
	hsp = -7;	
	image_xscale = -1.25;
	//sprite_index = spr_player;  messing things up
	state = PLAYERSTATETEST.WALK;
		#region Parallax Scrolling
		// Parallax Scrolling
...
if(keyboard_check_pressed(ord("M"))) {
	state = PLAYERSTATETEST.ATTACK_MEELE;
